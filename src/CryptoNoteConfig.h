...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0xe5766; // addresses start with "K"
...
const uint64_t MONEY_SUPPLY                                  = MoneysupplyPlaceholder;
...
const uint64_t DIFFICULTY_TARGET                             = DifficultyPlaceholder; // seconds
...
const char     CRYPTONOTE_NAME[]                             = "NamePlaceholder";
...
const int      P2P_DEFAULT_PORT                              =  PortPlaceholder;
const int      RPC_DEFAULT_PORT                              =  RpcPlaceholder;
